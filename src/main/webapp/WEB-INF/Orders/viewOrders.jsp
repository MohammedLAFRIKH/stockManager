...
<%@page import="com.example.stockmanager.dao.OrderDAOImpl"%>
<%@page import="com.example.stockmanager.dao.OrderDAO"%>
<%@page import="com.example.stockmanager.model.Orders"%>
<%@page import="com.example.stockmanager.dao.CategoryDAOImpl"%>
<%@page import="com.example.stockmanager.dao.CategoryDAO"%>
<%@page import="com.example.stockmanager.model.Category"%>
<%@page import="com.example.stockmanager.dao.ProductDAOImpl"%>
<%@page import="com.example.stockmanager.dao.ProductDAO"%>
<%@page import="com.example.stockmanager.model.Product"%>
<%@page import="com.example.stockmanager.model.OrdersProduct"%>
<%@page import="com.example.stockmanager.dao.OrdersProductDAOImpl"%>
<%@page import="com.example.stockmanager.dao.OrdersProductDAO"%>
